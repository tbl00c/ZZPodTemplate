...
{
    // 设置组件全局参数
    ZZAppContext *context = [[ZZAppContext alloc] init];
    [context setLaunchOptions:launchOptions];
    [[ZZModuleCenter center] setContext:context];
    
    // 组件初始化
    [[ZZModuleCenter center] moduleInit];
